...
function glyph(id){const wan=['🀇','🀈','🀉','🀊','🀋','🀌','🀍','🀎','🀏'],tiao=['🀐','🀑','🀒','🀓','🀔','🀕','🀖','🀗','🀘'],tong=['🀙','🀚','🀛','🀜','🀝','🀞','🀟','🀠','🀡'],hon=['🀀','🀁','🀂','🀃','🀄','🀅','🀆'];if(id<9)return wan[id];if(id<18)return tong[id-9];if(id<27)return tiao[id-18];return hon[id-27]}
function tileInner(x){return `<div class="mahjongGlyph">${glyph(x.id)}</div>`}
